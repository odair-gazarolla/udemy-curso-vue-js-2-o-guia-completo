<template>
	<div class="auth-content">
		<div class="auth-modal">
			...
			<input v-if="showSignup" v-mode="user.name" type="text" placeholder="Nome">
			...
			<input v-if="showSignup" v-mode="user.confirmPassword" type="password" placeholder="Confirme a Senha">
